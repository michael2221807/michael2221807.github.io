...
function returnArray(i = "") {
  ...
  let romaji = dictionaryData["words"][i]["romaji"];

  return [kanji, kana, english, romaji];
}
...
function searchBy(arrayIndex = "", searchText = "") {
  ...
  let romaji = returnArray(arrayIndex)[3];
  

  let itemRow = "undefined";
  let div = document.createElement("div");
  if (kanji.includes(searchText) || kana.includes(searchText) || english.includes(searchText) || romaji.includes(searchText)) {
